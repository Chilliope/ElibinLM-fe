<template>
  <div class="flex flex-col lg:justify-between lg:flex-row-reverse">
    <div class="flex">
      ...
      <router-link to="/pengunjung" class="capitalize text-blue-500"
        >pengunjung perpustakaan</router-link
      >/
      <router-link to="/statistik-pengunjung" class="capitalize text-blue-500"
        >statistik</router-link
      >/
    </div>
    <div>
      <h1 class="capitalize text-xl font-medium lg:text-2xl">
        statistik pengunjung perpustakaan
      </h1>
      <p class="capitalize lg:text-lg">
        selamat datang di statistik pengunjung perpustakaan
      </p>
    </div>
  </div>
  <div
  ...
  >
    <div class="px-8 my-4 flex justify-between">
      ...
      <div>
        <router-link class="hidden lg:block" to="/pengunjung"
          >Data Pengunjung Perpustakaan</router-link
        >
      </div>
    </div>
    ...
    >
      <div class="w-max">
        ...
        <ul class="relative -top-[32.1rem] left-2 flex gap-3">
          ...
          >
            <div
              class="bg-blue-500 w-6 bar-animation"
...
const { statsData, visitor } = useStats();
...
async function exportPDF() {
  ...
  // Save the PDF
  pdf.save(`stats-pengunjung-perpustakaan_${currentDate}.pdf`);
}
</script>
