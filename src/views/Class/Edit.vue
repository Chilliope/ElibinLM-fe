      ...
      <form class="capitalize flex flex-col gap-3 w-full lg:flex-row">
          <div class="flex flex-col gap-3 w-full">
              <div class="flex flex-col">
                  ...
                  <input type="text" class="text-black rounded-lg px-3 py-2 capitalize outline-none border border-slate-400" placeholder="kelas">
              </div>
              <div class="flex flex-col">
                  <label for="jurusan" class="font-medium text-slate-500">jurusan</label>
                  <select class="text-black rounded-lg px-3 py-2 capitalize outline-none border border-slate-400">
              ...
              <div class="flex flex-col">
                  <label for="jurusan" class="font-medium text-slate-500">Alphabet</label>
                  <select class="text-black rounded-lg px-3 py-2 capitalize outline-none border border-slate-400">
              ...
              <div class="flex flex-row justify-between pb-8 capitalize">
                  <router-link to="/kelas" class="w-max h-max px-6 py-3 rounded-xl bg-red-500 text-white hover:bg-red-400 hover:duration-150">batal</router-link>
